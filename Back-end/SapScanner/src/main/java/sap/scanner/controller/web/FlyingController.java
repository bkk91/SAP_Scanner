...
public class FlyingController {
	...
	private static final Logger logger = LoggerFactory.getLogger(FlyingController.class);

	@RequestMapping(value = "/flight-booking.do", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/flight-list.do", method = RequestMethod.GET)
	public String list(Locale locale, Model model) {
		...
		return "/flying/flight-list";
	}
	
	@RequestMapping(value = "/flight-single.do", method = RequestMethod.GET)
