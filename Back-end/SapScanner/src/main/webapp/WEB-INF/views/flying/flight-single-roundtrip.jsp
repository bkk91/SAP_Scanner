					...
					<div class="single-content-wrap padding-top-60px">
						...
						<div id="description" class="page-scroll">
							<div class="single-content-item pb-4">
								<p>
									<span
										class="badge badge-warning text-white font-weight-medium font-size-17">
										[왕복 / 직항] </span> <span> <br>
									</span> <br>
								</p>
								<h3 class="title font-size-26">
									<c:out value="${RfirstList.depCityNm} " />
									>>>
									<c:out value=" ${RfirstList.arrCityNm}" />
								</h3>
								<p>출발하는날</p>
							...
							<div class="single-content-item py-4">
								<div class="row">
									<div class="col-lg-4 col-sm-4">
										<div class="single-feature-titles text-center mb-3">
											...
											<span class="font-size-13"><c:out
													value="${RfirstList.depPlandTime}" /></span>
										</div>
									</div>
									<!-- end col-lg-4 -->
									<div class="col-lg-4 col-sm-4">
									...
									<div class="col-lg-4 col-sm-4">
										<div class="single-feature-titles text-center mb-3">
											...
											<span class="font-size-13"><c:out
													value="${RfirstList.arrPlandTime}" /></span>
										</div>
									</div>
									<!-- end col-lg-4 -->
									<div class="col-lg-12">
										<div
											...
											<h3 class="title font-size-15 font-weight-medium">
												총 운항 시간: <span
													...
													약<c:out value=" ${RfirstList.seatStatus}" />시간
												</span>
											</h3>
										</div>
									</div>
									...
									<div class="col-lg-4 responsive-column">
										<div
											...
											<div class="single-feature-titles">
												...
												<span class="font-size-13"><c:out
														value="${RfirstList.airlineNm}" /></span>
											</div>
										</div>
									...
									<div class="col-lg-4 responsive-column">
										<div
											...
											<div class="single-feature-titles">
												<h3 class="title font-size-15 font-weight-medium">좌석 등급</h3>
												<span class="font-size-13"><c:out
														value="${RfirstList.seatGrade}" /></span>
											</div>
										</div>
										<!-- end single-tour-feature -->
									</div>
									...
									<div class="col-lg-4 responsive-column">
										<div
											...
											<div class="single-feature-titles">
												<h3 class="title font-size-15 font-weight-medium">결제 가격</h3>
												<span class="font-size-13"><c:out value="${firstSum}" />원
													(<c:out value="${totCount}" />인)</span>
											</div>
										</div>
										<!-- end single-tour-feature -->
									</div>
								...
								<div class="single-content-item pb-4">
									...
									<h3 class="title font-size-26">
										<c:out value="${RsecondList.arrCityNm} " />
										>>>
										<c:out value=" ${RsecondList.depCityNm}" />
									</h3>
									<p>돌아오는날</p>
									<div class="d-flex align-items-center pt-2"></div>
								</div>
								...
								<div class="row">
									<div class="col-lg-4 col-sm-4">
										<div class="single-feature-titles text-center mb-3">
											<h3 class="title font-size-15 font-weight-medium">이륙 시간</h3>
											<span class="font-size-13"><c:out
													value="${RsecondList.depPlandTime}" /></span>
										</div>
									</div>
									<!-- end col-lg-4 -->
									<div class="col-lg-4 col-sm-4">
									...
									<div class="col-lg-4 col-sm-4">
										<div class="single-feature-titles text-center mb-3">
											<h3 class="title font-size-15 font-weight-medium">착륙 시간</h3>
											<span class="font-size-13"><c:out
													value="${RsecondList.arrPlandTime}" /></span>
										</div>
									</div>
									<!-- end col-lg-4 -->
									<div class="col-lg-12">
										<div
											...
											<h3 class="title font-size-15 font-weight-medium">
												총 운항 시간: <span
													class="font-size-13 d-inline-block ml-1 text-gray">
													약<c:out value=" ${RsecondList.seatStatus}" />시간
												</span>
											</h3>
										</div>
									</div>
									...
									<div class="col-lg-4 responsive-column">
										<div
											...
											<div class="single-feature-titles">
												<h3 class="title font-size-15 font-weight-medium">항공사</h3>
												<span class="font-size-13"><c:out
														value="${RsecondList.airlineNm}" /></span>
											</div>
										</div>
										<!-- end single-tour-feature -->
									</div>
									...
									<div class="col-lg-4 responsive-column">
										<div
											...
											<div class="single-feature-titles">
												<h3 class="title font-size-15 font-weight-medium">좌석 등급</h3>
												<span class="font-size-13"><c:out
														value="${RsecondList.seatGrade}" /></span>
											</div>
										</div>
										<!-- end single-tour-feature -->
									</div>
									...
									<div class="col-lg-4 responsive-column">
										<div
											...
											<div class="single-feature-titles">
												<h3 class="title font-size-15 font-weight-medium">결제 가격</h3>
												<span class="font-size-13"><c:out
														value="${secondSum}" />원 (<c:out value="${totCount}" />인)</span>
											</div>
										</div>
										<!-- end single-tour-feature -->
									</div>
								...
								<div class="accordion accordion-item padding-top-30px"
									...
									<div class="card">
										...
										<div id="faqCollapseSeven" class="collapse"
											...
											data-parent="#accordionExample2">
											<div class="card-body d-flex">
												<p>출발일 기준 1주내 환불 시 100% 5일 90% 3일 80% 2일 70% 1일 50% 환불가능</p>
											</div>
										</div>
									</div>
									<!-- end card -->
						...
						<div class="sidebar-widget single-content-widget">
									...
									<p>
										<span class="text-form">가격</span><span
											class="text-value ml-2 mr-1"> <c:out
												value="${discountSum}" />원
										</span> <span class="before-price"> <c:out value="${totalSum}" />원
										</span>
									</p>
								</div>
							</div>
							...
							<div class="sidebar-widget-item">
								<div
									...
									<label class="font-size-16">출발하는 날짜 <span>출발</span></label>
									<div class="qtyBtn d-flex align-items-center">
										<c:out value=" ${RfirstList.depPlandTime}" />
									</div>
								</div>
								<br>
								<div
									class="qty-box mb-2 d-flex align-items-center justify-content-between">
									<label class="font-size-16">출발하는 날짜 <span>회항</span></label>
									<div class="qtyBtn d-flex align-items-center">
										<c:out value=" ${RsecondList.depPlandTime}" />
									</div>
								</div>
								<br>
								<div
									...
									<div class="qtyBtn d-flex align-items-center">
										<c:out value=" ${RfirstList.seatGrade}" />
									</div>
								</div>
								<br>
							</div>
							...
							<div class="sidebar-widget-item">
								<div
									class="qty-box mb-2 d-flex align-items-center justify-content-between">
									<label class="font-size-16">탑승객 <span>24개월 미만 제외</span></label>
									<div class="qtyBtn d-flex align-items-center">
							...
							<div class="sidebar-list">
								<ul class="list-items">
									...
									<li><i class="la la-microphone icon-element mr-2"></i>실시간
										고객서비스</li>
									<li><i class="la la-file-text icon-element mr-2"></i>무료 발권
										보험</li>
								</ul>
							</div>
							<!-- end sidebar-list -->
