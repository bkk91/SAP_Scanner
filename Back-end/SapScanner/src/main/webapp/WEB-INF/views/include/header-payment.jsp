...
<script type="text/javascript">
	$(document).ready(function() {
		// 편도 검색하기
		$(".search_single_btn").on("click", function() {
			flightSearchSingle();
		})
		// 왕복 검색하기
		$(".search_double_btn").on("click", function() {
			flightSearchDouble();
		})
	})
	
	// 편도 검색
	function flightSearchSingle() {
		$.ajax({
			type: 'post',
			url: 'flyingSearchSingle.do',
			dataType: 'text',
			data: $('#searchSingleForm').serialize(), // json -> serialize? 해쉬 밸류 : int 값
			success: function(data) {
				console.log(data);
				location.href = "flight-list.do";
			},
			error: function(e) {
				console.log(e);
			}
	...
	// 왕복 검색
	function flightSearchDouble(){
		$.ajax({
			type: 'post',
			url: 'flyingSearchDouble.do',
			dataType: 'text',
			data: $('#searchDoubleForm').serialize(),
			success: function(data) {
				console.log(data);
				location.href = "flight-list.do";
			},
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="menu-wrapper">
							...
							<div class="logo">
								<a href="../index.jsp"><img src="${pageContext.request.contextPath}/images/logo.png" alt="logo"></a>
							...
							<div class="main-menu-content">
								<nav>
									<ul>
										...
										<li><a href="../search/hotel-list.do">호텔</a></li>
												...
												<ul class="row no-gutters">
													...
													<li class="col-lg-5 mega-menu-item">
														<ul>
															...
															<li><a href="../user/user-dashboard.do">사용자 대쉬보드</a></li>
