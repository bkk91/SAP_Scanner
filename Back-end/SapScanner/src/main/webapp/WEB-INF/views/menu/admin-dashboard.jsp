			...
			<div class="section-tab section-tab-2 text-center pt-4 pb-3 pl-4">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item"><a class="nav-link active"
						id="notification-tab" data-toggle="tab" href="#notification"
					...
					<li class="nav-item"><a class="nav-link" id="message-tab"
						...
						aria-controls="message" aria-selected="false"> Messages </a></li>

					<li class="nav-item"><a class="nav-link" id="account-tab"
						data-toggle="tab" href="#account" role="tab"
						...
						<div class="notification-item">
							...
							<div class="list-group drop-reveal-list user-drop-reveal-list">
								<a href="user-dashboard-profile.html"
									...
									<!-- end msg-body -->
								</a> <a href="user-dashboard-booking.html"
									class="list-group-item list-group-item-action">
									<div class="msg-body">
										<div class="msg-content">
											<h3 class="title">
									...
									<!-- end msg-body -->
								</a> <a href="user-dashboard-reviews.html"
									class="list-group-item list-group-item-action">
									<div class="msg-body">
										<div class="msg-content">
											<h3 class="title">
									...
									<!-- end msg-body -->
								</a> <a href="user-dashboard-settings.html"
									class="list-group-item list-group-item-action">
									<div class="msg-body">
										<div class="msg-content">
											<h3 class="title">
		...
		<div class="sidebar-nav-body">
			...
			<div class="sidebar-menu-wrap">
				<ul class="sidebar-menu toggle-menu list-items">
					<li class="page-active"><a href="admin-dashboard.html"><i
							class="la la-dashboard mr-2"></i>Dashboard</a></li>
					<li><a href="admin-dashboard-booking.html"><i
							class="la la-shopping-cart mr-2 text-color"></i>Booking</a></li>
					<li><span class="side-menu-icon toggle-menu-icon"> <i
							class="la la-angle-down"></i>
					</span> <a href="admin-dashboard-orders.html"><i
							class="la la-list mr-2 text-color-2"></i>Orders</a>
						<ul class="toggle-drop-menu">
							<li><a href="admin-dashboard-orders-details.html">Order
									Details</a></li>
						</ul></li>
					<li><span class="side-menu-icon toggle-menu-icon"> <i
							class="la la-angle-down"></i>
					</span> <a href="admin-dashboard-travellers.html"><i
							class="la la-users mr-2 text-color-3"></i>Travellers</a>
						<ul class="toggle-drop-menu">
							<li><a href="admin-dashboard-traveler-detail.html">Traveller
									Details</a></li>
						</ul></li>
					<li><a href="admin-dashboard-visa.html"><i
							class="la la-plane mr-2 text-color-4"></i>Visa Application</a></li>
					<li><a href="admin-dashboard-reviews.html"><i
							class="la la-star mr-2 text-color-5"></i>Reviews</a></li>
					<li><a href="admin-dashboard-wishlist.html"><i
							class="la la-heart mr-2 text-color-6"></i>Wishlist</a></li>
					<li><a href="admin-dashboard-travel-agents.html"><i
							class="la la-text-width mr-2 text-color-7"></i>Travel Agents</a></li>
					<li><span class="side-menu-icon toggle-menu-icon"> <i
							class="la la-angle-down"></i>
					</span> <a href="#"><i class="la la-area-chart mr-2 text-color-8"></i>Finance</a>
						<ul class="toggle-drop-menu">
					...
					<li><span class="side-menu-icon toggle-menu-icon"> <i
							class="la la-angle-down"></i>
					</span> <a href="#"><i class="la la-map-signs mr-2 text-color-9"></i>Locations</a>
						<ul class="toggle-drop-menu">
							<li><a href="admin-countries.html">Countries</a></li>
							<li><a href="admin-airlines.html">Airlines</a></li>
						</ul></li>
					<li><a href="admin-dashboard-settings.html"><i
							class="la la-cog mr-2 text-color-10"></i>Settings</a></li>
					<li><a href="index.html"><i
							class="la la-power-off mr-2 text-color-11"></i>Logout</a></li>
				</ul>
			</div>
									...
									<div class="notification-item mr-2">
										<div class="dropdown">
											<a href="#" class="dropdown-toggle drop-reveal-toggle-icon"
												...
												aria-haspopup="true" aria-expanded="false"> <i
												class="la la-envelope"></i> <span class="noti-count">4</span>
											</a>
											<div
												class="dropdown-menu dropdown-reveal dropdown-menu-xl dropdown-menu-right">
												<div class="dropdown-header drop-reveal-header">
													<h6 class="title">
														You have <strong class="text-black">4</strong> messages
													</h6>
												</div>
												<div class="list-group drop-reveal-list">
													<a href="#" class="list-group-item list-group-item-action">
														<div class="msg-body d-flex align-items-center">
															...
															<div class="msg-content w-100">
																...
																<p class="msg-text">Ancillae delectus necessitatibus
																	no eam</p>
															</div>
														</div>
														<!-- end msg-body -->
										...
										<div class="dropdown">
											<a href="#" class="dropdown-toggle" id="userDropdownMenu"
												...
												<div class="d-flex align-items-center">
													...
													<span class="font-size-14 font-weight-bold">Royel
														Admin</span>
												</div>
											</a>
											<div
												...
												<div
													...
													<a href="admin-dashboard-settings.html"
														...
														<div class="msg-body">
															<div class="msg-content">
																<h3 class="title">
																	<i class="la la-user mr-2"></i> Edit Profile
																</h3>
															</div>
														</div>
														<!-- end msg-body -->
													</a> <a href="admin-dashboard-orders.html"
														class="list-group-item list-group-item-action">
														<div class="msg-body">
															<div class="msg-content">
																<h3 class="title">
																	<i class="la la-shopping-cart mr-2"></i>Orders
																</h3>
															</div>
														</div>
														<!-- end msg-body -->
														...
														<div class="msg-body">
															<div class="msg-content">
																<h3 class="title">
																	<i class="la la-bell mr-2"></i>Messages
																</h3>
															</div>
														</div>
														<!-- end msg-body -->
													</a> <a href="admin-dashboard-settings.html"
														class="list-group-item list-group-item-action">
														<div class="msg-body">
															<div class="msg-content">
																<h3 class="title">
						...
						<div class="col-lg-3 responsive-column-l">
							<div class="icon-box icon-layout-2 dashboard-icon-box pb-0">
								...
								<a href="admin-dashboard-booking.html"
									...
									All <i class="la la-angle-right"></i>
								</a>
							</div>
						</div>
						<!-- end col-lg-3 -->
				...
				<div class="container-fluid">
					<div class="row">
								...
								<div class="form-title-wrap">
									<div class="d-flex align-items-center justify-content-between">
										<ul class="chart-pagination d-flex">
											...
											<li><a href="#"
												class="theme-btn theme-btn-small theme-btn-transparent mr-2">Week</a></li>
											<li><a href="#"
												class="theme-btn theme-btn-small theme-btn-transparent">This
													year</a></li>
										</ul>
										...
										<a href="#"
											...
											<div class="msg-body d-flex align-items-center">
												...
												<span
													...
													data-toggle="tooltip" data-placement="left"
													title="Mark as read"> <i class="la la-check-square"></i>
												</span>
											</div>
											<!-- end msg-body -->
										</a> <a href="#" class="list-group-item list-group-item-action">
						...
						<div class="col-lg-12">
							<div class="form-box dashboard-card">
								<div class="form-title-wrap">
									<h3 class="title">Sales earning this month for each
										service</h3>
								</div>
								<div class="form-content">
									<div class="row">
										<div class="col-lg-3 responsive-column-l">
											<div
												...
												<a href="#"
													class="d-flex align-items-center justify-content-between view-all">View
													Details <i class="la la-arrow-right"></i>
												</a>
											</div>
										</div>
										<!-- end col-lg-3 -->
							...
							<div class="form-box dashboard-card">
								...
								<div class="form-content pb-0">
									<div class="dashboard-progressbar pb-4">
										...
										<p class="font-size-14 pt-1">Disk space usage: 1,746.5 /
											50,000 MB</p>
									</div>
									...
									<div class="dashboard-progressbar pb-4">
										...
										<p class="font-size-14 pt-1">Monthly Bandwidth Transfer:
											14,706.1 / 30.000</p>
									</div>
									<!-- end dashboard-progressbar -->
									<div class="dashboard-progressbar pb-4">
								...
								<div class="form-content py-0">
									<ul class="list-group list-group-flush">
										<li
											...
											Chrome <span class="badge bg-info text-white badge-pill">3,506</span>
										</li>
										<li
											class="list-group-item px-0 d-flex justify-content-between align-items-center">
											Firefox <span class="badge bg-info text-white badge-pill">2,405</span>
										</li>
										<li
											class="list-group-item px-0 d-flex justify-content-between align-items-center">
											Safari <span class="badge bg-info text-white badge-pill">300</span>
										</li>
										<li
											class="list-group-item px-0 d-flex justify-content-between align-items-center">
											Internet Explorer <span
											class="badge bg-info text-white badge-pill">200</span>
										</li>
										<li
											class="list-group-item px-0 d-flex justify-content-between align-items-center">
											Opera <span class="badge bg-info text-white badge-pill">111</span>
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="form-box dashboard-card">
								...
								<div class="form-content py-0">
									<ul class="list-group list-group-flush">
										<li
											class="list-group-item px-0 d-flex justify-content-between align-items-center">
											Desktop <span class="badge bg-info text-white badge-pill">6,506</span>
										</li>
										<li
											class="list-group-item px-0 d-flex justify-content-between align-items-center">
											Mobile <span class="badge bg-info text-white badge-pill">222</span>
										</li>
										<li
											class="list-group-item px-0 d-flex justify-content-between align-items-center">
											Tablet <span class="badge bg-info text-white badge-pill">65</span>
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="row align-items-center">
						<div class="col-lg-7">
							<div class="copy-right padding-top-30px">
								<p class="copy__desc">
									&copy; Copyright Trizen 2020. Made with <span
