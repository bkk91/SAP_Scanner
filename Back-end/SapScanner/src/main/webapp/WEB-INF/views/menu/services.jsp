			...
			<div class="col-lg-3 responsive-column">
				<div class="icon-box icon-layout-4">
					...
					<div class="info-content">
						...
						<p class="info__desc">Pellentesque ac turpis egestas, varius
							justo et, condimentum augue nerrowe.</p>
					</div>
					<!-- end info-content -->
				</div>
				<!-- end icon-box -->
		...
		<div class="row">
			<div class="col-lg-12">
				<div
					...
					<p class="font-size-15">Do not hesitate to contact us for
						better help and service.</p>
					<a href="contact.html" class="btn-text font-size-15">Contact us
			...
			<div class="col-lg-4 responsive-column">
				<div class="card-item ">
					...
					<div class="card-body">
						...
						<p class="card-meta">Duis cursus lectus sed dui imperdiet, id
							pharetra nunc ullamcorper.</p>
						...
						<div
							...
							<p>
								<span class="price__from">From</span> <span class="price__num">$100.00</span>
							</p>
							<span class="tour-hour"><i class="la la-clock-o mr-1"></i>7
								days</span>
						</div>
