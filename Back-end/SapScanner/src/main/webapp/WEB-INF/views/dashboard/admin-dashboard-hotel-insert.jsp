					...
					<div class="col-lg-12">
						<div class="form-box">
							<div class="form-title-wrap">
								<h3 class="title">호텔 등록</h3>
							</div>
							<!-- <form role="form" method="post" action="admin-hotel-insert.do">-->
							<form id = "hotelInsertForm" method="post" action="admin-hotel-insert.do" enctype = "multipart/form-data">
											...
											<tbody>
												<tr>
													<td><input type="text" name="hotelName"
														id="hotelName" required></td>
													<td><input type="text" name="hotelCountry"
														id="hotelCountry" required></td>
													<td><input type="text" name="hotelCity" id="hotelCity" required></td>
													<td><input type="text" name="hotelTel"
														id="hotelTel" required></td>
												</tr>
											</tbody>
											<thead>
												<tr>
													...
													<td colspan="4"><textarea cols="120" rows="4" id="hotelInfo" name="hotelInfo" required></textarea></td>
											<thead>
												<tr>
